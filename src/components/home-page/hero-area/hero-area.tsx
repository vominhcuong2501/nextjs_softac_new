...
export const HeroArea = () => {
  ...
  return (
    <div className='lg:pt-[270px] lg:pb-[170px] md:pt-[210px] md:pb-[150px] pt-[160px] pb-[100px] relative bg-gray-6 overflow-hidden'>
      {DATA_HERO_AREA?.list_images_shape_one?.map((img) => {
        return (
      ...
      <div className='max-w-[1200px] mx-auto px-4'>
        <div>
          <h3 className='font-light sm:font-extralight 2xl:text-[74px] text-black overflow-hidden xl:text-[65px] lg:text-[55px] md:text-[47px] text-[35px] leading-[0.8] hero-text-anim-2 grid grid-cols-1 tracking-[-0.03em]'>
            ...
            <i className='overflow-hidden inline-block'>
              <i className='translate-y-[150px] opacity-0 inline-block pb-5 child-2 not-italic'>
                <span className='font-bold tracking-[-0.03em]'>Management</span> With <br />
              </i>
            </i>
            <i className='overflow-hidden inline-block'>
              <i className='translate-y-[150px] opacity-0 inline-block pb-5 child-2 not-italic'>Software</i>
            </i>
          </h3>
          <Motion effect='fadeInUp' transition={{ delay: 0.5 }} className='duration-[0.9s]'>
            <p className='text-15 sm:text-16 font-normal text-gray-1 leading-1-5 mt-2'>
              A simple solution for building the optimal work <br className='hidden md:block' /> schedule for your business.
            </p>
          </Motion>

          <Motion effect='fadeInUp' transition={{ delay: 0.5 }} className='duration-[0.9s] flex items-center xs:flex-wrap pb-[30px] pt-[46px] mb-5 gap-4'
          >
            <Link className='tp-btn-blue-lg purple-bg circle-effect' href='/'>
              Get Started
            </Link>
            <Link className='tp-btn-grey' href='/service-details'>
              Try a Damo
            </Link>
          </Motion>
        </div>
      ...
      <div className='sm:absolute top-0 right-0 3xl:top-[-2%] 3xl:right-[-5%] 2xl:top-[-6%] 2xl:right-[-8%] xl:top-[-6%] xl:right-[-20%] lg:top-[-12%] lg:right-[-25%] '>
        {DATA_HERO_AREA?.list_images_shape_two?.map((img) => {
          return (
